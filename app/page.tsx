  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <motion.div
        ...
        className="text-center mb-8 w-full max-w-4xl px-4"
      >
      ...
      <motion.div
        ...
        className="glass-morphism rounded-3xl p-6 md:p-8 relative overflow-hidden w-full max-w-xl shadow-2xl border border-white/10"
      >
        ...
        <div className="space-y-8">
          {!file ? (
            <div className="group relative">
              ...
              />
              <div className="border-2 border-dashed border-border group-hover:border-primary/50 transition-all duration-300 rounded-2xl p-8 text-center flex flex-col items-center gap-3 bg-white/5 group-hover:bg-primary/5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-32 md:mt-40 w-full max-w-4xl px-4 mb-20">
        {[
